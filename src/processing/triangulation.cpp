...
/** Triangulation 3D point in the camera frame
@param pt1 2D pixel coordinate in left image
@param pt2 2D pixel coordinate in right image
@param projection_matrix1 projection matrix of left camera 3x4  P0 = [K0_rect 0]
@param projection_matrix2 projection matrix of right camera 3x4 P1 = [K1_rect 0]
output 3D point in camera0 frame
Linear-Eigen Method
*/
Vec3 Triangulation::triangulationPt(Vec2 pt1, Vec2 pt2, Mat3x4 projection_matrix1, Mat3x4 projection_matrix2)
{
    ...
    A.row(0)= PT1_pm1 - u1 * PT3_pm1;
    A.row(1)= PT2_pm1 - v1 * PT3_pm1;
    A.row(2)= PT1_pm2 - u2 * PT3_pm2;
    A.row(3)= PT2_pm2 - v2 * PT3_pm2;
...
@param pt1 2D pixel coordinate in left image
@param pt2 2D pixel coordinate in right image
@param T_c_w1 lm_1st_obs_frame_pose
@param T_c_w2 T_c_w
output 3D point in camera0 frame
Linear-Eigen Method
*/
