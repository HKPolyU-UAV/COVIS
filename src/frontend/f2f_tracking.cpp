                       ...
                       )
{
  ...
  // shared and manipulated by different class method
  this->vimotion      = std::make_shared<VIMOTION>(T_i_c0_in,  9.81,
  ...
  this->minParallax    = kf_para(0);
  this->minTranslation = kf_para(1);
  this->minRotation    = kf_para(2);
                             ...
                             bool &reset_cmd)
{
  ...
  case UnInit:
  {
    ...
    if(this->init_frame())
    {
      ...
      cout << "first keyfame " << keyframe_buf.size() <<  endl;
  ...
  case Tracking:
  {
    ...
    {
      CameraFrame::Ptr kf_last = keyframe_buf.back();
      //        cout << "kf_curr: " << curr_frame->frame_id << endl;
      //        cout << "kf_last: " << kf_last->frame_id << endl;
