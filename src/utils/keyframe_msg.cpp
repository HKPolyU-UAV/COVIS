...
//        {
//            cout << "getKeyFrame: " << lm_id.at(i) << " " << lm_2d.at(i).transpose() << " "  << lm_3d.at(i).transpose() << endl;
//        }
...
//    }
    ...
    kf_merge_pub.publish(kf);
}

void KeyFrameMsg::unpack(covis::KeyFrameConstPtr kf_const_ptr,
                         int64_t         &frame_id,
                         size_t          &AgentId_,
                         cv::Mat         &img0,
                         cv::Mat         &img1,
